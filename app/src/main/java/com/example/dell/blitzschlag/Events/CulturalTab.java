...
public class CulturalTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.cultural_tab, container, false);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                if(obj.getString("category").equals("cultural")){
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener{
        ...
        private CulturalTab.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final CulturalTab.ClickListener clickListener) {
